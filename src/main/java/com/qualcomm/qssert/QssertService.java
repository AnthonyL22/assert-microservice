...
import com.qualcomm.qssert.matcher.QualcommCustomMatchers;
...
public class QssertService {
    ...
    public QssertService() {
    }

    public QssertService(final boolean enableHardAssertions) {
        QssertService.enableHardAssertions = enableHardAssertions;
    }
    ...
    public static void assertContainsNotInOrder(final String message, final String source, String... target) {
        assertThat(message, source, CoreMatchers.is(new QualcommCustomMatchers.StringContainsNotInOrderMatcher(Arrays.asList(target))));
    }
    ...
    public static void assertCollectionContains(final String message, final Collection actualSources, final Object expected) {
        assertThat(message, actualSources, CoreMatchers.is(new QualcommCustomMatchers.CollectionContainsMatcher(expected)));
    }

    public static void assertCollectionNotContains(final String message, final Collection actualSources, final Object expected) {
        assertThat(message, actualSources, CoreMatchers.is(not(new QualcommCustomMatchers.CollectionContainsMatcher(expected))));
    }

    public static void assertRegexTrue(final String message, final Object actual, final String regex) {
        assertThat(message, actual, CoreMatchers.is(new QualcommCustomMatchers.RegexMatcher(regex)));
    }

    public static void assertRegexFalse(final String message, final Object actual, final String regex) {
        assertThat(message, actual, CoreMatchers.is(not(new QualcommCustomMatchers.RegexMatcher(regex))));
    }
    ...
    public static void assertJsonFieldEquals(final String message, final JsonPath actualSource, final Object expectedField, final Object expected) {
        assertThat(message, actualSource, CoreMatchers.is(new QualcommCustomMatchers.JsonMatcher(expectedField, expected)));
    }
    ...
    public static void assertJsonFieldNotEquals(final String message, final JsonPath actualSource, final Object expectedField, final Object expected) {
        assertThat(message, actualSource, CoreMatchers.is(not(new QualcommCustomMatchers.JsonMatcher(expectedField, expected))));
    }
    ...
    public static void assertJsonContainsField(final String message, final JsonPath actualSource, final Object expectedField) {
        assertThat(message, actualSource, CoreMatchers.is(new QualcommCustomMatchers.JsonMatcher(expectedField, null)));
    }
    ...
    public static void assertJsonNotContainsField(final String message, final JsonPath actualSource, final Object expectedField) {
        assertThat(message, actualSource, CoreMatchers.is(not(new QualcommCustomMatchers.JsonMatcher(expectedField, null))));
    }
